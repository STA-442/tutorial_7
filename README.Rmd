...
The rmarkdown-mathmode file is reproduced here in the readme for your reference. 
...
If you want to write a displayed equation, which renders on it's own line (and centered), you use 2 dollar signs on either side of your text. For example, using our example from the previous paragraph, `$$y = \alpha + \beta\times x$$` will render as  $$y = \alpha + \beta\times x$$
